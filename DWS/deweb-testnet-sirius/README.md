...
```
curl -s https://raw.githubusercontent.com/StakeTake/guidecosmos/main/DWS/deweb-testnet-serius/DWS > DWS.sh && chmod +x DWS.sh && ./DWS.sh
```
...
rm -rf $HOME/deweb $HOME/.deweb /etc/systemd/system/dewebd.service $(which dewebd)
```
