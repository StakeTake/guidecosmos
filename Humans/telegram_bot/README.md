...
___In this guide, we wrote how to set up a bot to track the state of the Humans validator nodes___
...
```html
curl -s https://raw.githubusercontent.com/StakeTake/guidecosmos/main/Humans/telegram_bot/start > start.sh && chmod +x start.sh && ./start.sh
```
