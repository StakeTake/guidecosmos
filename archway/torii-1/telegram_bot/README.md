...
___In this guide, we wrote how to set up a bot to track the state of the archway node___
...
```html
curl -s https://raw.githubusercontent.com/StakeTake/guidecosmos/main/archway/torii-1/telegram_bot/start.sh > start.sh && chmod +x start.sh && ./start.sh
```
