...
```
curl -s https://raw.githubusercontent.com/StakeTake/guidecosmos/main/umee/canon-3/umee > umee.sh && chmod +x umee.sh && ./umee.sh
```
...
wget -O $HOME/.umee/config/addrbook.json "https://raw.githubusercontent.com/StakeTake/guidecosmos/main/umee/canon-3/addrbook.json"
